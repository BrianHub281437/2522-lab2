...
public class Date
{
    ...
    /**
     * Constructs a Date object with the current date.
     * Uses the system calendar to get today's date.
     */
    public Date()
    {
        ...
        this.month = today.get(Calendar.MONTH) + 1; // Calendar months are 0-indexed
